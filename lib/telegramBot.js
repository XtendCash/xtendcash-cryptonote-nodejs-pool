...
function sendPoolStats(chatId) {
    apiInterfaces.pool('/stats', function(error, stats) {    
        ...
        var networkHashrate = utils.getReadableHashRate(stats.network.difficulty / stats.config.coinDifficultyTarget * 32);
        ...
        var response = '';
        response += '*' + poolHost + '*\n';
        response += 'Graphrate: ' + poolHashrate + '\n';
        ...
        response += '\n';
        response += '*Network*\n';
        response += 'Graphrate: ' +  networkHashrate + '\n';
...
function sendMinerStats(telegramMsg, address) {
    ...
    apiInterfaces.pool('/stats_address?address='+address, function(error, data) {
        ...
        response += 'Graphrate: ' + minerHashrate + '\n';
